...
public partial class Excavations_Page : ContentPage
{
    ...
    public Excavations_Page(string name)
	{
        ...
        Quest_excavations.Text = "РАСКОПКИ ДРЕВНОСТЕЙ ОЧЕНЬ КРОПОТЛИВЫЙ \r\nПРОЦЕСС, В ПЕСКАХ СПРЯТАНЫ МНОГИЕ\r\n АРТЕФАКТЫ, КОТОРЫЕ ВАМ НАДО БУДЕТ НАЙТИ\r\n ИСПОЛЬЗУЯ КИСТЬ И ЛОПАТКУ.";
        Quest_excavations1.Text = "НАЙДИТЕ АРХЕОЛОГА ДЛЯ ПОЛУЧЕНИЯ ПОДРОБНОЙ ИНФОРМАЦИИ";
        ;
    }
